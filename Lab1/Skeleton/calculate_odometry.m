...
ome_R=2*pi*e_R/E_T/delta_t;
ome_L=2*pi*e_L/E_T/delta_t;
ome=(ome_R*R_R-ome_L*R_L)/B;
v=(ome_R*R_R+ome_L*R_L)/2;
u=[v*delta_t*cos(mu(3));v*delta_t*sin(mu(3));ome*delta_t];
end